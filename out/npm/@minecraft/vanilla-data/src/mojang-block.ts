 ...
 */
export type AcaciaShelfStates = Pick<
    BlockStateSuperset,
 ...
 */
export type AndesiteWallStates = Pick<
    BlockStateSuperset,
 ...
 */
export type BambooShelfStates = Pick<
    BlockStateSuperset,
    'minecraft:cardinal_direction' | 'powered_bit' | 'powered_shelf_type'
>;
 ...
 */
export type BirchShelfStates = Pick<
    BlockStateSuperset,
    'minecraft:cardinal_direction' | 'powered_bit' | 'powered_shelf_type'
>;
 ...
 */
export type BrickWallStates = Pick<
    BlockStateSuperset,
    | 'wall_connection_type_east'
    | 'wall_connection_type_north'
    | 'wall_connection_type_south'
 ...
 */
export type CherryShelfStates = Pick<
    BlockStateSuperset,
    'minecraft:cardinal_direction' | 'powered_bit' | 'powered_shelf_type'
>;
 ...
 */
export type CrimsonShelfStates = Pick<
    BlockStateSuperset,
    'minecraft:cardinal_direction' | 'powered_bit' | 'powered_shelf_type'
>;
 ...
 */
export type DarkOakShelfStates = Pick<
    BlockStateSuperset,
    'minecraft:cardinal_direction' | 'powered_bit' | 'powered_shelf_type'
>;
 ...
 */
export type DioriteWallStates = Pick<
    BlockStateSuperset,
    | 'wall_connection_type_east'
    | 'wall_connection_type_north'
    | 'wall_connection_type_south'
 ...
 */
export type EndStoneBrickWallStates = Pick<
    BlockStateSuperset,
    | 'wall_connection_type_east'
    | 'wall_connection_type_north'
    | 'wall_connection_type_south'
 ...
 */
export type GraniteWallStates = Pick<
    BlockStateSuperset,
    | 'wall_connection_type_east'
    | 'wall_connection_type_north'
    | 'wall_connection_type_south'
 ...
 */
export type JungleShelfStates = Pick<
    BlockStateSuperset,
    'minecraft:cardinal_direction' | 'powered_bit' | 'powered_shelf_type'
>;
 ...
 */
export type MangroveShelfStates = Pick<
    BlockStateSuperset,
    'minecraft:cardinal_direction' | 'powered_bit' | 'powered_shelf_type'
>;
 ...
 */
export type MossyCobblestoneWallStates = Pick<
    BlockStateSuperset,
    | 'wall_connection_type_east'
    | 'wall_connection_type_north'
    | 'wall_connection_type_south'
 ...
 */
export type MossyStoneBrickWallStates = Pick<
    BlockStateSuperset,
    | 'wall_connection_type_east'
    | 'wall_connection_type_north'
    | 'wall_connection_type_south'
 ...
 */
export type NetherBrickWallStates = Pick<
    BlockStateSuperset,
    | 'wall_connection_type_east'
    | 'wall_connection_type_north'
    | 'wall_connection_type_south'
 ...
 */
export type OakShelfStates = Pick<
    BlockStateSuperset,
    'minecraft:cardinal_direction' | 'powered_bit' | 'powered_shelf_type'
>;
 ...
 */
export type PaleMossCarpetStates = Pick<
    BlockStateSuperset,
 ...
 */
export type PaleOakDoorStates = Pick<
    BlockStateSuperset,
    'door_hinge_bit' | 'minecraft:cardinal_direction' | 'open_bit' | 'upper_block_bit'
>;
 ...
 */
export type PaleOakFenceGateStates = Pick<
    BlockStateSuperset,
    'in_wall_bit' | 'minecraft:cardinal_direction' | 'open_bit'
>;
 ...
 */
export type PaleOakHangingSignStates = Pick<
    BlockStateSuperset,
    'attached_bit' | 'facing_direction' | 'ground_sign_direction' | 'hanging'
>;
 ...
 */
export type PaleOakShelfStates = Pick<
    BlockStateSuperset,
    'minecraft:cardinal_direction' | 'powered_bit' | 'powered_shelf_type'
>;
 ...
 */
export type PrismarineWallStates = Pick<
    BlockStateSuperset,
    | 'wall_connection_type_east'
    | 'wall_connection_type_north'
    | 'wall_connection_type_south'
 ...
 */
export type RedNetherBrickWallStates = Pick<
    BlockStateSuperset,
    | 'wall_connection_type_east'
    | 'wall_connection_type_north'
    | 'wall_connection_type_south'
 ...
 */
export type RedSandstoneWallStates = Pick<
    BlockStateSuperset,
    | 'wall_connection_type_east'
    | 'wall_connection_type_north'
    | 'wall_connection_type_south'
 ...
 */
export type ResinBrickWallStates = Pick<
    BlockStateSuperset,
    | 'wall_connection_type_east'
    | 'wall_connection_type_north'
    | 'wall_connection_type_south'
 ...
 */
export type SandstoneWallStates = Pick<
    BlockStateSuperset,
    | 'wall_connection_type_east'
    | 'wall_connection_type_north'
    | 'wall_connection_type_south'
 ...
 */
export type SpruceShelfStates = Pick<
    BlockStateSuperset,
    'minecraft:cardinal_direction' | 'powered_bit' | 'powered_shelf_type'
>;
 ...
 */
export type StoneBrickWallStates = Pick<
    BlockStateSuperset,
    | 'wall_connection_type_east'
    | 'wall_connection_type_north'
    | 'wall_connection_type_south'
 ...
 */
export type WarpedShelfStates = Pick<
    BlockStateSuperset,
    'minecraft:cardinal_direction' | 'powered_bit' | 'powered_shelf_type'
>;
...
export type BlockStates =
    ...
    | BorderBlockStates
    | BrainCoralFanStates
    | BrainCoralWallFanStates
    | BrewingStandStates
    | BrickDoubleSlabStates
    | BrickSlabStates
    | BrickStairsStates
    | BrickWallStates
    | BrownCandleStates
    ...
    | CobblestoneDoubleSlabStates
    | CobblestoneSlabStates
    | CobblestoneWallStates
    | CocoaStates
    | ColoredTorchBlueStates
    | ColoredTorchGreenStates
    | ColoredTorchPurpleStates
    | ColoredTorchRedStates
    | CommandBlockStates
    | ComposterStates
    | CompoundCreatorStates
    | CopperBulbStates
    | CopperChainStates
    | CopperChestStates
    | CopperDoorStates
    | CopperGolemStatueStates
    | CopperLanternStates
    | CopperTorchStates
    ...
    | CutRedSandstoneDoubleSlabStates
    | CutRedSandstoneSlabStates
    | CutSandstoneDoubleSlabStates
    ...
    | DarkOakWoodStates
    | DarkPrismarineDoubleSlabStates
    | DarkPrismarineSlabStates
    ...
    | DeadBubbleCoralWallFanStates
    | DeadFireCoralFanStates
    | DeadFireCoralWallFanStates
    | DeadHornCoralFanStates
    | DeadHornCoralWallFanStates
    | DeadTubeCoralFanStates
    | DeadTubeCoralWallFanStates
    | DecoratedPotStates
    | DeepslateStates
    ...
    | DriedGhastStates
    | DropperStates
    | ElementConstructorStates
    | EndBrickStairsStates
    | EndPortalFrameStates
    | EndRodStates
    | EndStoneBrickDoubleSlabStates
    | EndStoneBrickSlabStates
    | EndStoneBrickWallStates
    | EnderChestStates
    | ExposedCopperBulbStates
    | ExposedCopperChainStates
    | ExposedCopperChestStates
    | ExposedCopperDoorStates
    | ExposedCopperGolemStatueStates
    ...
    | MushroomStemStates
    | NetherBrickDoubleSlabStates
    | NetherBrickSlabStates
    | NetherBrickStairsStates
    | NetherBrickWallStates
    | NetherWartStates
    | NormalStoneDoubleSlabStates
    | NormalStoneSlabStates
    ...
    | OxidizedCopperChainStates
    | OxidizedCopperChestStates
    | OxidizedCopperDoorStates
    | OxidizedCopperGolemStatueStates
    | OxidizedCopperLanternStates
    | OxidizedCopperTrapdoorStates
    | OxidizedCutCopperSlabStates
    | OxidizedCutCopperStairsStates
    | OxidizedDoubleCutCopperSlabStates
    | OxidizedLightningRodStates
    | PaleHangingMossStates
    | PaleMossCarpetStates
    | PaleOakButtonStates
    | PaleOakDoorStates
    | PaleOakDoubleSlabStates
    | PaleOakFenceGateStates
    | PaleOakHangingSignStates
    | PaleOakLeavesStates
    | PaleOakLogStates
    | PaleOakPressurePlateStates
    | PaleOakSaplingStates
    | PaleOakShelfStates
    | PaleOakSlabStates
    | PaleOakStairsStates
    | PaleOakStandingSignStates
    | PaleOakTrapdoorStates
    | PaleOakWallSignStates
    | PaleOakWoodStates
    | PearlescentFroglightStates
    | PeonyStates
    | PetrifiedOakDoubleSlabStates
    ...
    | PolishedAndesiteDoubleSlabStates
    | PolishedAndesiteSlabStates
    ...
    | PolishedDioriteDoubleSlabStates
    | PolishedDioriteSlabStates
    | PolishedDioriteStairsStates
    | PolishedGraniteDoubleSlabStates
    | PolishedGraniteSlabStates
    ...
    | PrismarineBrickDoubleSlabStates
    | PrismarineBrickSlabStates
    | PrismarineBricksStairsStates
    | PrismarineDoubleSlabStates
    | PrismarineSlabStates
    | PrismarineStairsStates
    | PrismarineWallStates
    | PumpkinStates
    | PumpkinStemStates
    | PurpleCandleStates
    ...
    | PurpurBlockStates
    | PurpurDoubleSlabStates
    | PurpurPillarStates
    | PurpurSlabStates
    | PurpurStairsStates
    | QuartzBlockStates
    | QuartzDoubleSlabStates
    | QuartzPillarStates
    | QuartzSlabStates
    | QuartzStairsStates
    | RailStates
    ...
    | RedNetherBrickDoubleSlabStates
    | RedNetherBrickSlabStates
    | RedNetherBrickStairsStates
    | RedNetherBrickWallStates
    | RedSandstoneDoubleSlabStates
    | RedSandstoneSlabStates
    ...
    | ResinBrickSlabStates
    | ResinBrickStairsStates
    | ResinBrickWallStates
    | ResinClumpStates
    | RespawnAnchorStates
    | RoseBushStates
    | SandstoneDoubleSlabStates
    | SandstoneSlabStates
    ...
    | SmokerStates
    | SmoothQuartzStates
    | SmoothQuartzDoubleSlabStates
    | SmoothQuartzSlabStates
    | SmoothQuartzStairsStates
    | SmoothRedSandstoneDoubleSlabStates
    | SmoothRedSandstoneSlabStates
    | SmoothRedSandstoneStairsStates
    | SmoothSandstoneDoubleSlabStates
    | SmoothSandstoneSlabStates
    | SmoothSandstoneStairsStates
    | SmoothStoneDoubleSlabStates
    ...
    | StoneBrickDoubleSlabStates
    | StoneBrickSlabStates
    | StoneBrickStairsStates
    | StoneBrickWallStates
    | StoneButtonStates
    ...
    | StrippedPaleOakLogStates
    | StrippedPaleOakWoodStates
    ...
    | WaxedCopperChainStates
    | WaxedCopperChestStates
    | WaxedCopperDoorStates
    | WaxedCopperGolemStatueStates
    | WaxedCopperLanternStates
    ...
    | WaxedExposedCopperChainStates
    | WaxedExposedCopperChestStates
    | WaxedExposedCopperDoorStates
    | WaxedExposedCopperGolemStatueStates
    | WaxedExposedCopperLanternStates
    ...
    | WaxedExposedLightningRodStates
    | WaxedLightningRodStates
    | WaxedOxidizedCopperBulbStates
    | WaxedOxidizedCopperChainStates
    | WaxedOxidizedCopperChestStates
    | WaxedOxidizedCopperDoorStates
    | WaxedOxidizedCopperGolemStatueStates
    | WaxedOxidizedCopperLanternStates
    ...
    | WaxedOxidizedLightningRodStates
    | WaxedWeatheredCopperBulbStates
    | WaxedWeatheredCopperChainStates
    | WaxedWeatheredCopperChestStates
    | WaxedWeatheredCopperDoorStates
    | WaxedWeatheredCopperGolemStatueStates
    | WaxedWeatheredCopperLanternStates
    ...
    | WaxedWeatheredLightningRodStates
    | WeatheredCopperBulbStates
    | WeatheredCopperChainStates
    | WeatheredCopperChestStates
    | WeatheredCopperDoorStates
    | WeatheredCopperGolemStatueStates
    | WeatheredCopperLanternStates
